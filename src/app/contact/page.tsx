      ...
      <div className="max-w-4xl mx-auto px-6 py-20">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-lg shadow-xl p-8">
            <h2 className="text-3xl font-light font-bodoni mb-6 text-black">Send us a message</h2>
          ...
          <div className="space-y-8">
            <div className="bg-white rounded-lg shadow-xl p-8">
              <h2 className="text-3xl font-light font-bodoni mb-6 text-black">Connect With Us</h2>
            ...
            <div className="bg-black text-white rounded-lg shadow-xl p-8">
              <h2 className="text-3xl font-light font-bodoni mb-6">Our Mission</h2>
        ...
        <div className="mt-16 text-center">
          <div className="bg-white rounded-lg shadow-xl p-8">
            <h2 className="text-3xl font-light font-bodoni mb-6 text-black">Customer Support</h2>
