...
export default function AccessoriesPage() {
  ...
  const accessoryProducts = comprehensiveProducts.filter(p => 
      ...
      <div className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto font-barlow-condensed">
            ...
            From caps to beanies, each piece features subtle Modern Arab branding.
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          ...
          <Link href="/collections/accessories" className="bg-black text-white px-6 py-3 rounded-lg font-semibold">
            Accessories
          </Link>
        </div>
              ...
              <Link href={`/products/${product.slug}`}>
                ...
                <div className="p-6">
                  ...
                  <p className="text-gray-600 mb-4 text-sm line-clamp-3 font-barlow-condensed">
                    {product.description || "Premium accessory featuring Modern Arab branding and quality construction."}
                  </p>
        ...
        <div className="mt-20 bg-white rounded-lg shadow-xl p-8">
          <h2 className="text-3xl font-light mb-8 text-center text-black font-bodoni">Accessory Features</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-light mb-3 text-black font-bodoni">Premium Materials</h3>
              <p className="text-gray-600 font-barlow-condensed">
                High-quality materials including cotton canvas, soft knits, 
                and durable construction for long-lasting wear.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-light mb-3 text-black font-bodoni">Embroidered Branding</h3>
              <p className="text-gray-600 font-barlow-condensed">
                Subtle Modern Arab embroidered logos and branding 
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-light mb-3 text-black font-bodoni">Versatile Styling</h3>
              <p className="text-gray-600 font-barlow-condensed">
                Unisex designs that complement any outfit, 
                from casual streetwear to elevated everyday looks.
              </p>
            </div>
          </div>
        </div>
