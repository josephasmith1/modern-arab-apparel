      ...
      <div className="relative z-10 py-12">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
            ...
            <motion.div
              className="md:flex md:space-x-12 space-y-4 md:space-y-0"
              initial={{ opacity: 0, y: 30 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <Link href="/products" className="block text-stone-700 hover:text-stone-900 transition-colors font-barlow-condensed">All Products</Link>
                  <Link href="/products?category=tees" className="block text-stone-700 hover:text-stone-900 transition-colors font-barlow-condensed">Tops & Tees</Link>
                  <Link href="/products?category=hoodies" className="block text-stone-700 hover:text-stone-900 transition-colors font-barlow-condensed">Layers</Link>
                  <Link href="/products?category=headwear" className="block text-stone-700 hover:text-stone-900 transition-colors font-barlow-condensed">Headwear</Link>
                  <Link href="/products?category=bottoms" className="block text-stone-700 hover:text-stone-900 transition-colors font-barlow-condensed">Bottoms</Link>
                </div>
              </div>
